    ...
    "privacy": LegalPage(
        ...
        sections=(
            ...
            (
                ...
                "До внедрения автоматического обезличивания кнопка 'Ответ не подошел' не сохраняет сырой текст запроса. "
                "В проблемный запрос записывается только служебное безопасное значение.",
            ),
            (
    ...
    "personal-data-consent": LegalPage(
        ...
        sections=(
            ...
            (
                ...
                "До внедрения модуля обезличивания сервис не сохраняет сырой текст проблемного пользовательского запроса "
                "при нажатии 'Ответ не подошел'.",
            ),
            (
                "4. Отзыв согласия",
